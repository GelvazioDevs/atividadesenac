function loadAlunosGithub(data_exercicios) {
    const aListaAlunos = new Array(
        ...
        Array(4, 'Borges66', 'status_ok', 'Enrico Borges Pedron', data_exercicios, ''),
        Array(5, 'Caio245js', 'status_ok', 'Caio', data_exercicios, ''),
        Array(6, 'jragrello', 'status_ok', 'CARLOS AMAURY AGRELLO JUNIOR', data_exercicios, ''),
        Array(7, 'Will1712', 'status_ok', 'Bernardo Carvalho Will', data_exercicios, ''),
        Array(8, 'luizpauloao', 'status_ok', 'Luiz Paulo Alves de Oliveira', data_exercicios, ''),
        Array(9, 'joaophheinz', 'status_ok', 'Joao pedro heinz', data_exercicios, ''),
        Array(10, 'Malu-Oliveira', 'status_ok', 'Maria Luisa Farias de Oliveira', data_exercicios, ''),
        Array(11, 'IPedringoI', 'status_ok', 'Pedro Eduardo Dias Nacimento', data_exercicios, ''),
        Array(12, 'crismartinssc', 'status_ok', 'Cristian Martins', data_exercicios, ''),
        Array(13, 'Pam1590', 'status_ok', 'Pâmela Kunze', data_exercicios, ''),
        Array(14, 'estou aprendendo', 'status_ok', 'caroline dos santo soares', data_exercicios, ''),
        Array(15, 'IPedringoI', 'status_ok', 'Pedro Eduardo Dias Nacimento', data_exercicios, ''),
        Array(16, 'VanessaPereiradaSilva', 'status_ok', 'Vanessa Pereira da Silva', data_exercicios, ''),
        ...
        Array(19, 'nananzoka', 'status_ok', 'natasha nunes dos santos', data_exercicios, ''),
        ...
        Array(22, 'BrunaBandeira2609', 'status_ok', 'Bruna Dos Santos Bandeira ', data_exercicios, ''),
